...
// Menangani form submission untuk privacy policy
...
// Menangani form submission untuk about
...
// Menangani form submission untuk contact
if (isset($_POST['contact-submit'])) {
    // Menggunakan filter_input untuk mendapatkan nilai input yang benar
        ...
        <div class="box-body">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="general-tab" data-bs-toggle="tab" href="#general" role="tab"
                        aria-controls="general" aria-selected="true">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="system-tab" data-bs-toggle="tab" href="#system" role="tab"
                        aria-controls="system" aria-selected="false">Contact</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="attributions-tab" data-bs-toggle="tab" href="#attributions" role="tab"
                        aria-controls="attributions" aria-selected="false">Privacy Policy</a>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade active show" id="general" role="tabpanel" aria-labelledby="general-tab">
                    <div class="col-md-6">
                        <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="post">
                            <div class="mb-3">
                                <textarea class="form-control" style="resize:none" required rows="20"
                                    name="about"><?= $about[0]['about'] ?></textarea>
                            </div>
                            <div class="mb-3 text-end">
                                <button name="about-submit" class="btn btn-success" type="submit"><i
                ...
                <div class="tab-pane fade" id="system" role="tabpanel" aria-labelledby="system-tab">
                    <div class="col-md-6">
                        <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="post">
                            ...
                            <div class="mb-3">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="instagram" class="form-control"
                                        value="<?= $ig[0]['value'] ?>">
                                    <input name="ig-id" value="<?= $ig[0]['id'] ?>" hidden>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="input-group mb-3">
                            ...
                            <div class="mb-3 text-end">
                                <button class="btn btn-success" name="contact-submit" type="submit"><i
                                        class="fas fa-check"></i> Update</button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="tab-pane fade" id="attributions" role="tabpanel" aria-labelledby="attributions-tab">
                    ...
                    <p class="text-muted">Copyright (c)
                        <script>document.write(new Date().getFullYear());</script> Tapyta Furniture. All rights
                        reserved.
                    </p>
                    <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="post">
                        <textarea class="form-control" name="policy" style="resize:none" required
                            rows="20"><?= $privacyPolicy[0]['policy'] ?></textarea>
                        <div class="mb-3 text-end">
                            <button class="btn btn-success" name="policy-submit" type="submit"><i
                                    class="fas fa-check"></i> Update</button>
                        </div>
                    </form>
                </div>
