...
if (isset($_POST['submit'])) {
    ...
    // Memeriksa dan melakukan update jika field 'firstname' diisi
    ...
    // Memeriksa dan melakukan update jika field 'password' diisi
...
if (isset($_GET['id'])) {
    ...
    // Memeriksa apakah form untuk menghapus data customer telah disubmit
...
<div class="container">
    <div class="page-title">
        <h3>Customers
            <a href="/admin/customers/create" class="btn btn-sm btn-outline-primary float-end"><i
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <form action="/admin/customers" method="post">
                                            ...
                                            <a href="/admin/customers?id=<?= $customer['id']; ?>"
